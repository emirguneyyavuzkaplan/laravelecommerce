                    ...
                    <div class="tab-contents">
                        <div class="tab-content-item active" id="digital_1a">
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{route('product.details',['slug'=>$Iproduct->slug])}}" title="{{$Iproduct->name}}">
                                            <figure><img src="{{asset('assets/images/products')}}/{{$Iproduct->image}}" width="800" height="800" alt="{{$Iproduct->name}}"></figure>
                                        </a>

                                    </div>
                                    <div class="product-info">
                                        <a href="{{route('product.details',['slug'=>$Iproduct->slug])}}" class="product-name"><span>{{$Iproduct->name}}</span></a>
                                        <div class="wrap-price"><span class="product-price">${{$Iproduct->regular_price}}</span></div>
                                    </div>
                                </div>
                                @endforeach
